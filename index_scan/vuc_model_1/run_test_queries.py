...
if __name__ == "__main__":
	...
	ranges = np.loadtxt("/home/dsladmin/Documents/vishal/index_scan/vuc_model_1/test_data.txt")
	...
	for i in range(ranges.size):
		...
		conn,cur = connect("localhost", 5432, "imdb_full", "dsladmin")
		result = run_query(cur,'cast_info_movie_id_sorted',int(ranges[i]))
		# close_connection(conn)
	...
	np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vuc_model_1/actual_times.txt',total_minus_startup_exec_time,delimiter=',');
	np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vuc_model_1/est_times.txt',est_time,delimiter=',');
