...
if __name__ == "__main__":
	...
	for j in range(0,2):
		...
		ranges = np.loadtxt("/home/dsladmin/Documents/vishal/index_scan/vuc_model_minus_1_2/ranges.txt")
		...
		for i in range(ranges.size):
			...
			conn,cur = connect("localhost", 5432, "imdb_full", "dsladmin")
			result = run_query(cur,'cast_info_movie_id_sorted_desc_2',int(ranges[i]))
			# close_connection(conn)
		...
		np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vuc_model_minus_1_2/times'+str(j+1)+'.txt',total_minus_startup_exec_time,delimiter=',')
		np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vuc_model_minus_1_2/est_times'+str(j+1)+'.txt',est_times,delimiter=',')
