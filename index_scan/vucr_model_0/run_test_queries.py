...
if __name__ == "__main__":
	...
	ranges = np.loadtxt("/home/dsladmin/Documents/vishal/index_scan/vucr_model_0/test_data.txt")
	...
	for i in range(0,ranges.size,2):
		...
		conn,cur = connect("localhost", 5432, "imdb_full", "dsladmin")
		result = run_query(cur,'cast_info',int(ranges[i]), int(ranges[i+1]))
		# close_connection(conn)
	...
	np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vucr_model_0/actual_times.txt',total_minus_startup_exec_time,delimiter=',');
	np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vucr_model_0/est_times.txt',est_time,delimiter=',');
