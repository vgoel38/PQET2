...
if __name__ == "__main__":
	...
	for j in range(0,2):
		...
		while i<2331601:
			...
			conn,cur = connect("localhost", 5432, "imdb_full", "dsladmin")
			result = run_query(cur,'cast_info_movie_id_sorted_desc',i)
			# close_connection(conn)
		...
		os.system(start_server)
		conn,cur = connect("localhost", 5432, "imdb_full", "dsladmin")
		result = run_query(cur,'cast_info_movie_id_sorted_desc',2331601+1)
		# close_connection(conn)
		...
		np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vu_model_minus_1/times'+str(j+1)+'.txt',total_minus_startup_exec_time,delimiter=',');
		np.savetxt('/home/dsladmin/Documents/vishal/index_scan/vu_model_minus_1/ranges.txt',ranges,delimiter=',');